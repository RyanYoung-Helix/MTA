...
{
    [AddIn("Download", Version = "1.0.0.0")]
    public class RC_Download : IReportCommand
    {
        ...
        public void Execute(IList<IReportRow> rows)
        {
            ...
            sfd.FileName = this.currFileAttachmentName;
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                fileFullPath = sfd.FileName;
                //download file
        ...
        public Image Image16
        {
            get
            {
                return Properties.Resources.download_icon;
            }
        }
        ...
        public string Tooltip
        {
            get
            {
                return "Download the current File Attachment";
            }
        }
